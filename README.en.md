...
The client **reads** market data and holdings directly via Firestore realtime subscriptions, while every
**write that moves assets goes through FastAPI**, keeping order processing and balance arithmetic on the
